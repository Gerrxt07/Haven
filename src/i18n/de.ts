export const de = {
	...
	home: {
		title: "Chats",
		secure_chat_title: "Haven",
		secure_chat_subtitle: "Privater Chat von Person zu Person",
		chats_tab: "Chats",
	...
	friends: {
		...
		add_friend_placeholder: "Benutzername eingeben",
		add_friend_btn: "Hinzufügen",
		add_friend_sending: "Wird gesendet...",
		add_friend_success: "Freundschaftsanfrage gesendet!",
		add_friend_error: "Anfrage konnte nicht gesendet werden",
		incoming_title: "Eingehende Anfragen",
		outgoing_title: "Ausstehende Anfragen",
		friends_title: "Freunde",
		no_incoming: "Keine eingehenden Freundschaftsanfragen.",
		no_outgoing: "Keine ausstehenden Anfragen.",
		no_friends: "Noch keine Freunde — füge jemanden oben hinzu!",
		accept: "Annehmen",
		decline: "Ablehnen",
		accepting: "Wird angenommen...",
		declining: "Wird abgelehnt...",
		from_user: "von {{username}}",
		to_user: "an {{username}}",
		loading: "Laden...",
		refresh: "Aktualisieren",
		badge_incoming: "{{count}} neu",
